namespace QE {
    ...
    export class Plane {
        ...
        public fromPoints(p1: Vector3, p2: Vector3, p3: Vector3) {
            ...
            // 向量1
            const v1x: number = p2.x - p1.x;
            const v1y: number = p2.y - p1.y;
            const v1z: number = p2.z - p1.z;

            // 向量2
            const v2x: number = p3.x - p1.x;
            const v2y: number = p3.y - p1.y;
            const v2z: number = p3.z - p1.z;
