namespace QE {
    ...
    export class WebGLBufferManager {
        ...
        public createIndexBuffer(indexes: number[], usage: BufferUsage, useShadowBuffer: boolean): WebGLIndexBuffer {
            const buf: WebGLIndexBuffer = new WebGLIndexBuffer(indexes, usage, useShadowBuffer);
